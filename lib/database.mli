...
(** [insert_table db name columns] Creates a new table with the specified name
    [name] and columns [columns] and inserts it into the database [db].
    ...
    @note Does not change the database if a table with the specified name already exists. *)
